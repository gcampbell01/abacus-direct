...
class EntryManager(models.Manager):
    def all_published(self, **kwargs):
        return self.filter(is_published=True, **kwargs).order_by('-weight')
...
class Entry(models.Model):
    ...
    tags = models.ManyToManyField(
        Tag, blank=True)
    weight = models.IntegerField(blank=True, null=True, help_text='The total count of page hits')
...
class Article(Entry):
    cover_image = models.ForeignKey(
        EntryImage, null=True, blank=True)
