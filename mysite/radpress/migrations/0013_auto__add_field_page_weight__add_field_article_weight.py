...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('radpress_page', 'weight', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'Article.weight'
        db.add_column('radpress_article', 'weight', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.weight'
        db.delete_column('radpress_page', 'weight')

        # Deleting field 'Article.weight'
        db.delete_column('radpress_article', 'weight')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 2, 9, 58, 34, 97517)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 2, 9, 58, 34, 97455)'}),
