...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('radpress_page', 'markup', self.gf('django.db.models.fields.CharField')(default='restructuredtext', max_length=20), keep_default=False)

        # Adding field 'Article.markup'
        db.add_column('radpress_article', 'markup', self.gf('django.db.models.fields.CharField')(default='restructuredtext', max_length=20), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('radpress_article', 'markup')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 12, 47, 28, 435190)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 12, 47, 28, 435128)'}),
